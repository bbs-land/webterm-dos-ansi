 ...
 */
export function renderAnsi(selector, content, bps) {
    ...
    wasm.renderAnsi(ptr0, len0, ptr1, len1, isLikeNone(bps) ? 0x100000001 : (bps) >>> 0);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('webterm_dos_ansi_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
